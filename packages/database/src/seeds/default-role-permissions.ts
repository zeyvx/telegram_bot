...
const ROLE_PERMISSION_MAP: Record<string, string[]> = {
  Owner: ["VIEW_MEMBERS", "MANAGE_MEMBERS", "MANAGE_ROLES", "ASSIGN_ROLES", "REMOVE_ROLES", "WARN_MEMBERS", "MUTE_MEMBERS", "BAN_MEMBERS", "DELETE_MESSAGES", "PIN_MESSAGES", "MANAGE_AUTOMATIONS", "VIEW_ANALYTICS", "MANAGE_SETTINGS", "MANAGE_BOT", "VIEW_LOGS"],
  Administrator: ["VIEW_MEMBERS", "MANAGE_MEMBERS", "MANAGE_ROLES", "ASSIGN_ROLES", "REMOVE_ROLES", "WARN_MEMBERS", "MUTE_MEMBERS", "BAN_MEMBERS", "DELETE_MESSAGES", "PIN_MESSAGES", "MANAGE_AUTOMATIONS", "VIEW_ANALYTICS", "MANAGE_SETTINGS", "VIEW_LOGS"],
  Moderator: ["VIEW_MEMBERS", "MANAGE_MEMBERS", "WARN_MEMBERS", "MUTE_MEMBERS", "BAN_MEMBERS", "DELETE_MESSAGES", "VIEW_LOGS"],
